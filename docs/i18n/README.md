...
`sima-i18n translate --locale <locale> --all --write` to refresh translations.
`translation-sources.json` is maintained by the CLI and records the English
source revision reviewed by each translation.
